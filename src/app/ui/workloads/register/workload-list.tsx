...
const WorkloadList = ({workloads}: {workloads: ResisteredWorkload[]|null}) => {
  ...
  return (
    <div className="flex flex-col w-full ps-6">
      <h3 className="w-full text-2xl underline underline-offset-1 mb-1">登録済み工数</h3>
      <div className="w-full ps-6">登録工数合計: {minute}分</div>
      <div className="flex flex-col border w-full ps-6">
